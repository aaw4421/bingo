...
const renderPage = () => {
  ...
  generateBoard({ version: "1", seed: 1, mode: "normal" }).then(
    ({ board }) => {
  ...
  const row = renderPopoutRow({
    title: "ROW1",
    goals: [
      "5 Different Types of Saplings",
      "Drink a Potion of Night Vision (8:00)",
      "Eat 24 Different Foods",
      "Kill 21 Different Monster Species",
      "Dye a Sheep Pink",
    ],
  });
